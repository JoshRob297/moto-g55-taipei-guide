#!/usr/bin/env bash
# ==============================================================================
# Moto G55 5G (XT2435-1 / taipei) Clean Fastboot Flash Script
# Author: JoshRob
# ==============================================================================
...
if ! command -v fastboot &> /dev/null; then
    echo "Error: 'fastboot' not found in PATH. Install Android platform-tools."
    exit 1
fi
...
for chunk in super.img_sparsechunk.*; do
    if [ -f "$chunk" ]; then
        echo "Flashing $chunk..."
        fastboot flash super "$chunk"
    fi
done
